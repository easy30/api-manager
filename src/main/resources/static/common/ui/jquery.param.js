        ...
        _build: function () {
            ...
            if (footBtn) {
                $.each(footBtn, function (index, footBtn) {
                    ...
                    if(type == 'import') {
                        var $importBtn = $('<button id="importBtn" class="btn btn-success btn-sm" type="button"  data-toggle="modal" data-target="#responseModal"  style="margin-left:6px;"></button>').append('&nbsp;' + footBtn.text);
